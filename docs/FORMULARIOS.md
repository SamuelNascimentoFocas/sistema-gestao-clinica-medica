...
| `src/components/administration/clinic-members-manager.tsx`          | Cadastro de membro; create   | fullName, email, password, roleCode                                                                                               | 1 objeto/4            | POST `C/members`; objeto completo do cadastro                                                             | Acrescenta membro/draft, limpa cadastro e exibe sucesso          |
