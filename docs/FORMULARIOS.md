...
| `src/components/administration/clinic-members-manager.tsx`          | Cadastro de membro; create   | fullName, email, password, roleId                                                                                                 | 1 objeto/4            | POST `C/members`; objeto completo do cadastro com perfil por UUID                                          | Acrescenta membro/draft, limpa cadastro e exibe sucesso          |
...
Os **14 schemas** estão em `frontend/src/lib/forms/form-schemas.ts`. Compartilham
...
| memberFormSchema                                                                    | Nome 3–180; email obrigatório até 254; senha 12–72 caracteres e até 72 bytes; três papéis locais                                                                                            | `clinic_member.ts`; limite em bytes também protegido na implementação backend. Não restringe a gramática de email ao default Zod                         |
